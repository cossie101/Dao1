...
const voteModule = sdk.getVoteModule(
  "0xFdfAD388C97B25bf0e552d3e6214CDB7882f9bCD",
);
...
const App = () => {
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to blockchain101DAO</h1>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h2>Blockchain101DAO Member Page</h2>
  ...
  return (
    <div className="mint-nft">
      <h2>Mint your free Blockchain101DAO Membership NFT</h2>
      <button
        disabled={isClaiming}
        onClick={() => {
          setIsClaiming(true);
